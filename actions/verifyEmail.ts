...
/**
 * @description
 * This action called in the verify-email page by passing the token obtained from the searchParam, this action check existence of token, expiry of the token, existence of user and finally updates the emailVerified field to new Date() for the user who is trying to verify and also delete the token in the end to ensure security and redundancy in the database.
 */